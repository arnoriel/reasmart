    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-lg relative">
        ...
        >
          ...
          <h1 className="font-display text-2xl text-sage-800">Join Reasmart</h1>
          <p className="font-body text-sm text-sage-500 mt-1">Your mindful reading journey starts here</p>
        </motion.div>
        ...
        <p className="text-center font-body text-xs text-sage-400 mt-6">
          By signing up, you agree to read mindfully and protect your mental wellbeing 🌿
        </p>
      </div>
    </div>
  )
